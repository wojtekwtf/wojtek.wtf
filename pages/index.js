  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 text-gray-900">
      ...
      <main className="flex flex-col items-center w-full flex-1 px-8 md:px-20 text-center font-mono">
        ...
        <p className="mb-10 w-4/5 max-w-screen-sm">im a software dev & founder of Mazury Labs, a collaborative effort for building decentralized professional identities & enabling global web3 talent</p>
